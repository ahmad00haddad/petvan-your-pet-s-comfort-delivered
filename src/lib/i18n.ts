...
export const copy = {
  en: {
    ...
    createAccountDesc: "Join PetVan today and manage your pet's life.",
    fullName: "Full Name",
    signUp: "Sign Up",
    ...
    iosInstallTitle: "Apple iOS Installation",
    iosInstallDesc: "Safari doesn't support automatic installation. Follow these 2 easy steps:",
  ...
  ar: {
    ...
    createAccountDesc: "انضم إلى PetVan اليوم وأدر حياة حيوانك الأليف.",
    ...
    iosInstallTitle: "تثبيت على أجهزة Apple iOS",
    iosInstallDesc: "متصفح Safari لا يدعم التثبيت التلقائي. اتبع هاتين الخطوتين السهلتين:",
