  ...
  return (
    <div className="mx-auto max-w-lg p-5 py-10 sm:p-8 min-h-screen animate-fade-in-up">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="font-display text-4xl font-extrabold text-primary mb-4 text-glow">
          {t.installApp}
        </h1>
        <p className="text-muted-foreground">{t.installAppDesc}</p>
      </div>
      ...
      <div className="rounded-3xl border border-border glass-panel p-6 shadow-[var(--shadow-card)] space-y-8 relative overflow-hidden">
        ...
        {isIOS && (
          <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground text-center mb-6">{t.iosInstallDesc}</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-bold">
                  {lang === "ar" ? "اضغط زر المشاركة" : "Tap the Share button"}
                </p>
                <p className="text-sm text-muted-foreground mt-1">
                  {lang === "ar"
                    ? "ابحث عن أيقونة المشاركة في أسفل متصفح Safari."
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-bold">
                  {lang === "ar" ? 'اضغط "إضافة إلى الشاشة الرئيسية"' : 'Tap "Add to Home Screen"'}
                </p>
                <p className="text-sm text-muted-foreground mt-1">
                  {lang === "ar"
                    ? "انزل في قائمة الإجراءات واضغط هذا الخيار."
